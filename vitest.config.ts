...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      provider: "v8",
      include: ["electron/srt.ts", "electron/json.ts", "electron/retry.ts", "electron/validation.ts", "electron/jobsLogic.ts", "electron/glossary.ts", "electron/version.ts", "shared/quota.ts", "shared/localizationLimits.ts", "shared/localizationLanguages.ts"],
    },
  },
});
